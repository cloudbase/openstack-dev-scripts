...
NETID2=`neutron net-create net2 | awk '{if (NR == 6) {print $4}}'`
SUBNETID2=`neutron subnet-create net2 10.0.2.0/24 --dns_nameservers list=true 8.8.8.8 | awk '{if (NR == 11) {print $4}}'`
